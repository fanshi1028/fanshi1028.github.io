...
langSwitchStrokeColor :: MisoString
#ifndef wasm32_HOST_ARCH
langSwitchStrokeColor = "stroke-purple-400"
#endif
#ifdef wasm32_HOST_ARCH
langSwitchStrokeColor = "stroke-orange-600"
#endif

switchToLangLogoSVGPath :: View model action
#ifndef wasm32_HOST_ARCH
switchToLangLogoSVGPath =
  path_
    [ class_ "fill-[#654FF0]",
...
toggleLangButtonSVG =
  svg_
    [ classes_
        [ switchToLangButtonBackgroundColor,
    ...
    [ switchToLangLogoSVGPath,
      path_
        [ classes_ ["stroke-2", langSwitchStrokeColor],
