...
makeSVG :: [View model action] -> View model action
makeSVG =
  svg_
    [ classes_
        [
          ...
          "hover:size-10 sm:hover:size-12 md:hover:size-16 lg:hover:size-20 xl:hover:size-24 2xl:hover:size-28"
        ],
...
#ifdef WASM
jsLogoSVGPath :: View model action
jsLogoSVGPath =
  path_
    [ class_ "fill-[#F7DF1E]",
...
#endif
#ifndef WASM
wasmLogoSVGPath :: View model action
wasmLogoSVGPath =
  path_
    [ class_ "fill-[#654FF0]",
