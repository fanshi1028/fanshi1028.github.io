  ...
  outputs =
    ...
    in
    {
      packages = builtins.mapAttrs (system: pkgs: {
        ...
        miso = pkgs.haskell.packages."ghc${ghcVersion}".miso; # TEMP FIXME
        haxl = applyFixToHaxl pkgs pkgs.haskell.packages."ghc${ghcVersion}".haxl;
        cborg = applyFixToCborg pkgs pkgs.haskell.packages."ghc${ghcVersion}".cborg;
