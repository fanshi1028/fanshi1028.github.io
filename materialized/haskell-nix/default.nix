{
  pkgs = hackage:
    {
      packages = {
        ...
        "hslua-module-text".revision = (((hackage."hslua-module-text")."1.0.1").revisions).default;
        "hslua-module-path".revision = (((hackage."hslua-module-path")."1.0.1").revisions).default;
        ...
        "hakyll".revision = (((hackage."hakyll")."4.15.1.1").revisions).default;
        ...
        "hslua-aeson".revision = (((hackage."hslua-aeson")."2.1.0").revisions).default;
        ...
        "hslua-core".revision = (((hackage."hslua-core")."2.1.0").revisions).default;
        ...
        "hslua-objectorientation".revision = (((hackage."hslua-objectorientation")."2.1.0").revisions).default;
        ...
        "hslua-module-version".revision = (((hackage."hslua-module-version")."1.0.1").revisions).default;
        ...
        "hslua".revision = (((hackage."hslua")."2.1.0").revisions).default;
        ...
        "texmath".revision = (((hackage."texmath")."0.12.4").revisions).default;
        ...
        "hslua-packaging".revision = (((hackage."hslua-packaging")."2.1.0").revisions).default;
        "pandoc-lua-marshal".revision = (((hackage."pandoc-lua-marshal")."0.1.4").revisions).default;
        ...
        "hslua-marshalling".revision = (((hackage."hslua-marshalling")."2.1.0").revisions).default;
        "hslua-classes".revision = (((hackage."hslua-classes")."2.1.0").revisions).default;
        ...
        "lua".revision = (((hackage."lua")."2.1.0").revisions).default;
        ...
        "ipynb".revision = (((hackage."ipynb")."0.2").revisions).default;
        ...
        "hslua-module-system".revision = (((hackage."hslua-module-system")."1.0.1").revisions).default;
        ...
        "pandoc".revision = (((hackage."pandoc")."2.17.1.1").revisions).default;
        ...
        "lpeg".revision = (((hackage."lpeg")."1.0.2").revisions).default;
  ...
  extras = hackage:
    { packages = { blog = ./.plan.nix/blog.nix; }; };
  modules = [
    ({ lib, ... }:
      { packages = { "blog" = { flags = {}; }; }; })
    ({ lib, ... }:
      {
        packages = {
          ...
          "pandoc-lua-marshal".components.library.planned = lib.mkOverride 900 true;
          ...
          "blog".components.exes."site".planned = lib.mkOverride 900 true;
          ...
          "hslua-aeson".components.library.planned = lib.mkOverride 900 true;
