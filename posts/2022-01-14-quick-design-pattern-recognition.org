...
In a parallel world, haskell is playing the same game too. Everything is a pure function, and to compensate the misfit, we have some beautiful and powerful abstractions: Monad, Algebraic Effect, etc.
